...
function convertDriveLinkToDirect(link) {
	if (link) {
		...
		if (fileIdMatch && fileIdMatch[1]) {
			...
			return null; // Handle invalid links
		}
	}
	else {
		return 'https://t4.ftcdn.net/jpg/00/89/55/15/240_F_89551596_LdHAZRwz3i4EM4J0NHNHy2hEUYDfXc0j.jpg'
	}
}
																...
																<div class="ttgr-item-inner">
																	...
																	<div class="tt-product">
																		<div class="tt-product-image-holder">
																			<a href="shop-single.html" class="tt-product-image-wrap">
																				<figure class="tt-product-image">
																					<img class="anim-zoomin tt-lazy" src="${convertDriveLinkToDirect(data[index]?.imageUrl)}" data-src="assets/img/shop/grid/product-1/product-1-1.jpg" alt="image" />
																				</figure> <!-- /.tt-product-image -->
																				
																				<figure class="tt-product-hover-image">
																					<img class="tt-lazy" src="${convertDriveLinkToDirect(data[index]?.imageUrl)}" data-src="assets/img/shop/grid/product-1/product-1-2.jpg" alt="image" />
																		...
																		<div class="tt-product-info">
																			...
																			<h3 class="tt-product-title"><a href="shop-single.html" title="Dash - Branding Mockup Templates">${data[index].Title}</a></h3>
																			...
																			<div class="tt-pi-price-btn-wrap">
																				<div class="tt-product-price">
																					<bdi>${data[index].discountedPrice}</bdi>
																					<!-- <ins class="pp-current-price"><bdi>$22.00</bdi></ins>
																					<del class="pp-old-price"><bdi>$23.00</bdi></del> -->
